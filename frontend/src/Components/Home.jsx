...
const Home = () => {
    return (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-customPurple font-semibold mb-28 mt-10">
            {[{ img: Appointment, title: "Appointment" }, { img: Diet, title: "Diet Recommendations" }, { img: Symptom, title: "Symptom Checker" }, { img: Map, title: "Nearest Hospital" }].map((item, index) => (
        ...
        <div className="text-black text-center mb-32 rounded-lg px-4">
        ...
        <div className="mb-28 flex justify-center">
            <img src={Healthcare} alt="Healthcare" className="w-full max-w-[250px] sm:max-w-md rounded-lg shadow-lg" />
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-10 lg:mt-0">
                {features.map((feature, index) => (
                    <div key={index} className="border-2 border-gray-300 rounded-lg p-4 w-40 sm:w-44 h-44 sm:h-48 flex flex-col items-center text-center hover:bg-gray-100 transition duration-200 shadow-md">
