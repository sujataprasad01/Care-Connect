...
const updateProfile = async (req, res) => {
    try {
        ...
        if (imageFile) {
            const imageUpload = await cloudinary.uploader.upload(imageFile.path); // Assuming file is from multer
...
//  API to make paymement of appointment using razorpay
...
export { registerUser, loginUser, getProfile, updateProfile, bookAppointment, cancelAppointment, paymentRazorpay , getUserAppointments}